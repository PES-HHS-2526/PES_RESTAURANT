 ...
 * en initialiseert de TCP-server op poort 9090.
 *
 ...
 *
 * Deze functie stelt de hostname van de Wemos in op "tafel1" en maakt daarna
 * verbinding met het opgegeven WiFi-netwerk.
 *
