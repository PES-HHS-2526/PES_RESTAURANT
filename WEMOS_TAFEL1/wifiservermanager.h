 ...
 *
 * Binnen de tafel 1-module wordt deze klasse gebruikt om klantoproepen naar
 ...
 * TCP-server op poort 9090. Raspberry Pi-A kan als client verbinden met deze
 * Wemos.
 *
 * De Wemos gebruikt deze klasse om berichten zoals "tafel1:1" te versturen
 * wanneer een klant hulp vraagt. Daarnaast kan de Wemos berichten zoals
 * "tafel1:0" ontvangen om de LED bij de tafel uit te schakelen.
 */
class WifiServerManager {
private:
    /*!
     ...
     *
     * De server luistert op poort 9090 en wacht op een verbinding van
     * Raspberry Pi-A.
     */
    WiFiServer server;
...
public:
     ...
     *
     * Deze functie wordt gebruikt om berichten zoals "tafel1:0" van
     * Raspberry Pi-A te ontvangen.
     *
     * @return Het ontvangen bericht als String, of een lege String als er geen
     * bericht beschikbaar is.
     */
    // Leest een binnenkomend bericht van de verbonden client (bijv. "LED:0")
    // Geeft lege string terug als er niets is
    String readMessage();
};
